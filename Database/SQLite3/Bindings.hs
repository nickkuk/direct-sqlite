...
foreign import ccall "wrapper"
    mkCFilterCallback :: CFilterCallback a -> IO (FunPtr (CFilterCallback a))

foreign import ccall "wrapper"
    mkCConflictCallback :: CConflictCallback a -> IO (FunPtr (CConflictCallback a))
